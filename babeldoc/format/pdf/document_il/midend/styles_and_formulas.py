...
class StylesAndFormulas:
    ...
    def process_page(self, page: Page):
        ...
        # TeX often uses different subset fonts for digits vs "." vs "%", so
        # ``99.00%`` becomes many style spans → DeepLX style-markers scramble
        # into ``99.BS5Q%``. Coalesce pure numeric/% runs under base style.
        self.coalesce_prose_number_style_spans(page)
