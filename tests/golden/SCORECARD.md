...
| PDF size / CJK font subset | ✅ 0.6.4.12: always subset (not gated by skip_clean); in-process fallback; garbage=4 save; log MB before/after — **operator accepted 2026-07-27** |
